...
class gameBoard():
    def __init__(self):
        ...
        def valid_moves(self):
            ...
            if 0 < move_loc_end[0]:
                moves.append(move(move_loc_end, (move_loc_end[0] - 1, move_loc_end[1])))
            if 3 > move_loc_end[0]:
                moves.append(move(move_loc_end, (move_loc_end[0] + 1, move_loc_end[1])))
            if 0 < move_loc_end[1]:
                moves.append(move(move_loc_end, (move_loc_end[0], move_loc_end[1] - 1)))
            if 3 > move_loc_end[1]:
                moves.append(move(move_loc_end, (move_loc_end[0], move_loc_end[1] + 1)))
            return moves
...
class move():
    def __init__(self, empty_loc_start, empty_loc_end):
